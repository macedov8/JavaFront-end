...
public class EditarCadastro extends JFrame {
    ...
    private final JButton deletarRegistroJButton = new JButton("✕");
    private final JLabel notificacaoJLabel = new JLabel("Notificações...");
    private final JButton adicionarNovoCadastroJButton = new JButton("+");;
    private final JButton limparCamposJButton = new JButton("←");
    ...
    public EditarCadastro() {
        ...
        limparCamposJButton.setToolTipText("Limpar");
